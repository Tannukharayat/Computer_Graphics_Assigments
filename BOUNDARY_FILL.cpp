...
class Poly{
    ...
    void boundfill(int x,int y,Color ,Color newcolor);
...
void Poly::boundfill(int x,int y,Color boundcol,Color newcolor){
    Color col;
    col=getpixel(x,y);
    if(!(col.r==boundcol.r && col.g==boundcol.g && col.b==boundcol.b) && !(col.r==newcolor.r && col.g==newcolor.g && col.b==newcolor.b)){
        setpixel(x,y,newcolor);
        boundfill(x+1,y,boundcol,newcolor);
        boundfill(x,y+1,boundcol,newcolor);
        boundfill(x-1,y,boundcol,newcolor);
        boundfill(x,y-1,boundcol,newcolor);
    }
}
...
void mymouse(int button,int state,int x,int y){
    ...
    if(complete && button==GLUT_LEFT_BUTTON && state==GLUT_DOWN){
        y=480-y;
        Color oldcolor;
        oldcolor.r=oldcolor.g=oldcolor.b=1;
        Color newcolor;
        newcolor.r=0;   newcolor.g=newcolor.b=1;
        p[0].boundfill(x,y,oldcolor,newcolor);
    }
